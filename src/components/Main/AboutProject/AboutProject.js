...
export default function AboutProject(props) {
    return (
        <MainBlocks title="О проекте" name="about-project" arialabel="Информация о проекте">
            <div className="about-project">
                ...
                <div className="about-project__progress">
                    ...
                    <div className="about-project__segment about-project__segment_type_four-weeks">
                        <p className="about-project__text about-project__text_type_four-weeks">4 недели</p>
                    </div>
